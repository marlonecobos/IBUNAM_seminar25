...
#See variables available to see response curves
names(fm$Models[[1]]$Full_model$betas)
...
# In this case, we don't have a selected model with products
# Let's use an example of the package to see the 2-way interaction plot
...
list.files(in_dir) #Raw variables downloades from WorldClim
